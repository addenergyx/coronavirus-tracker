...
app = dash.Dash(name='tracker', server=server, url_base_pathname='/tracker/', external_stylesheets=external_stylesheets, 
                meta_tags=[
                    ...
                    {
                        'name':'keywords',
                        'content':'coronavirus,coronavirus news,coronavirus outbreak,coronavirus update,covid19,n-covid19, ncov',
                    },                        

                    {
                        'property':'og:image',
                        'content':'https://ph-files.imgix.net/90568d34-4cf9-442d-87f4-8fe7bdee7a8d?auto=format&auto=compress&codec=mozjpeg&cs=strip&w=863.9665471923536&h=380&fit=max',
                    },
                    {
                        'name':'title',
