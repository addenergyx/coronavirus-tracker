...
def get_jhu_dataset():
    ...
    ## State level
    #nyt = COVID19Py.COVID19(url="https://covid-tracker-us.herokuapp.com", data_source="nyt") # data_source="nyt" doesn't work
...
ass = get_animation_from_postgres()
